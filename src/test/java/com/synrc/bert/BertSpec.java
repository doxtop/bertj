...
public class BertSpec {
    ...
    public void bert() {
        ...
        byte[] in = {
            (byte)131,104,5,108,0,0,0,2,104,2,107,0,5,115,121,110,114,99,107,0,3,100,120,116,
            104,2,107,0,5,115,121,110,114,99,107,0,3,53,72,84,106,109,0,0,0,6,97,99,116,
            105,118,101,70,64,9,30,(byte)184,81,(byte)235,(byte)133,31,97,(byte)128,98,127,(byte)255,(byte)255,(byte)255};

        // map tuples to object with decoder combinations
        final Dec<User> userDecoder     = tuple(el(1, stringDec), el(2, stringDec), User::new);
        final Dec<Roster> rosterDecoder = tuple(el(1, list(userDecoder)), el(2, binDec), el(3,floatDec), el(4,byteDec), el(5, intDec), Roster::new);
        ...
        final Enc<Roster> rosterEncoder = tuplee(ele(1, liste(userEncoder)), ele(2, binEnc), ele(3, floatEnc), ele(4, byteEnc), ele(5, intEnc),
        ...
        final Roster r = new Roster(l, "active".getBytes(UTF_8), 3.14, (byte)128, 2147483647);
